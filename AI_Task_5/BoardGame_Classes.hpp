...
public:
    ...
    void display_board();                                      // Assignment 3, Game 2
    bool is_winner();
    bool is_draw();
    bool game_is_over();
};
...
class Player {
    ...
    public:
        ...
        Player (char symbol, Board* b); // Needed for computer players
...
public:
    // Take a symbol and pass it to parent
    AI_player(char symbol, int dimension);
    // Generate a random move
    void get_move(int& x, int& y);
};
